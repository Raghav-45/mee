    ...
    <div className='flex flex-col'>
      ...
      <div className='flex flex-row gap-3'>
        <div className='relative flex flex-col flex-1 h-36 w-full justify-center items-center text-3xl bg-black/10 rounded-lg'>
          <img className='absolute top-0' src='https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_2730,h_1540/f_auto,q_auto/products/carousel/Taxi_Yellow.png' />
